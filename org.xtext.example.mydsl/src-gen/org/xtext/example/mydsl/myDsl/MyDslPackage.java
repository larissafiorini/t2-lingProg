...
public interface MyDslPackage extends EPackage
{
  ...
  /**
   * Returns the meta object for the attribute list '{@link org.xtext.example.mydsl.myDsl.Model#getOperation <em>Operation</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute list '<em>Operation</em>'.
   * @see org.xtext.example.mydsl.myDsl.Model#getOperation()
   * @see #getModel()
   * @generated
   */
  EAttribute getModel_Operation();
  ...
  interface Literals
  {
     ...
     * @generated
     */
    EAttribute MODEL__OPERATION = eINSTANCE.getModel_Operation();
